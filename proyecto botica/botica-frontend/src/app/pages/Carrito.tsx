...
export function Carrito() {
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="text-center py-16">
          <ShoppingCart size={64} className="mx-auto text-[#E5E7EB] mb-4" />
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <h1 className="text-3xl font-bold text-[#1A1F2E] mb-2">Tu carrito</h1>
      <p className="text-[#4A5260] mb-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-3">
          {items.map((item) => (
            <div
              key={item.product_id}
              className="bg-white rounded-xl border border-[#E5E7EB] p-4 flex gap-4"
            >
              <div className="w-24 h-24 flex-shrink-0 bg-[#FFF4EE] rounded-lg overflow-hidden">
                {item.image_url ? (
                  <img
                    src={item.image_url}
              ...
              <div className="flex-1 flex flex-col justify-between min-w-0">
                ...
                <div className="flex items-center justify-between mt-2">
                  <div className="flex items-center gap-1 bg-[#F9FAFB] rounded-lg">
                    <button
                      onClick={() => updateAmount(item.product_id, item.amount - 1)}
                      className="w-8 h-8 flex items-center justify-center hover:bg-[#E5E7EB] rounded-l-lg transition-colors"
                    ...
                    <button
                      onClick={() => updateAmount(item.product_id, item.amount + 1)}
                      className="w-8 h-8 flex items-center justify-center hover:bg-[#E5E7EB] rounded-r-lg transition-colors"
                  ...
                  <div className="text-right">
                    ...
                    <button
                      ...
                      className="text-xs text-[#DC2626] hover:underline flex items-center gap-1 mt-0.5"
                    >
                      <Trash2 size={12} />
                      Eliminar
                    </button>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl border border-[#E5E7EB] p-6 sticky top-4">
            <h2 className="font-bold text-[#1A1F2E] text-lg mb-4">
              Resumen del pedido
            </h2>

            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-[#4A5260]">Subtotal ({itemCount} productos)</span>
              ...
              {shippingCost > 0 && (
                <p className="text-xs text-[#4A5260] italic">
            ...
            <p className="text-xs text-center text-[#4A5260] mt-3">

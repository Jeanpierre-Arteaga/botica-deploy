  ...
  return (
    <div className="flex h-screen bg-page">
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                    isActive
                      ? 'bg-[#2D3F55] text-white border-l-4 border-brand'
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Top Bar */}
        <header className="bg-surface h-16 border-b border-line flex items-center justify-between px-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-sm text-muted">{formatDate(currentTime)}</span>
            <button
